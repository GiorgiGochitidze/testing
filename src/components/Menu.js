...
const Menu = ({Link, german, english, lists, setLists, setListsen, setListsgr, listsen, listsgr, georgia, en , ge ,gr}) => {
  const [listis, setListis] = useState(false)
    ...
    return ( 
        <>
            {ge && <div className="menu-container">
             ...
             <Link to='/News' style={{textDecoration: 'none', color: 'black'}}><p className="nav-links2">სიახლეები</p></Link>
                ...
                <div className='servise-listses firstes'>
                  ...
                  <Link to="/Library"><p>გალერეა</p></Link>
                </div>
                }
                </div>
             ...
             <Link to='/Proces' style={{textDecoration: 'none', color: 'black'}}><p className="nav-links10">რეგისტრაცია</p></Link>
            ...
            <div className="menu-container">
             ...
             <Link to='/Procesen' style={{textDecoration: 'none', color: 'black'}}><p className="nav-links10">Register</p></Link>
        ...
        {gr && <div className="menu-container">
             ...
             <Link to='/Procesgr' style={{textDecoration: 'none', color: 'black'}}><p className="nav-links10" href='#'>Anmeldung</p></Link>
